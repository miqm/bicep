...
namespace Bicep.Core.IntegrationTests.Semantics
{
    ...
    public class SemanticModelTests
    {
        ...
        {
            var compilation = new Compilation(TestTypeHelper.CreateEmptyProvider(), SyntaxTreeGroupingFactory.CreateFromText("parameter ", BicepTestConstants.FileResolver), BicepTestConstants.FileResolver);
