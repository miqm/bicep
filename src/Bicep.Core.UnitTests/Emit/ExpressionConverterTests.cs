...
namespace Bicep.Core.UnitTests.Emit
{
    ...
    public class ExpressionConverterTests
    {
        ...
        public void ShouldConvertExpressionsCorrectly(string text, string expected)
        {
            ...
            var compilation = new Compilation(TestTypeHelper.CreateEmptyProvider(), SyntaxTreeGroupingFactory.CreateFromText(programText, BicepTestConstants.FileResolver), BicepTestConstants.FileResolver);
