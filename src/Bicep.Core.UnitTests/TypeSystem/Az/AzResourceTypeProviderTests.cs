    ...
    public class AzResourceTypeProviderTests
    {
        ...
        public void AzResourceTypeProvider_should_warn_for_missing_resource_types()
        {
            Compilation createCompilation(string program)
                => new Compilation(AzResourceTypeProvider.CreateWithAzTypes(), SyntaxTreeGroupingFactory.CreateFromText(program, new Mock<IFileResolver>().Object), new Mock<IFileResolver>().Object);
...
");
        ...
        {
            Compilation createCompilation(string program)
                => new Compilation(BuiltInTestTypes.Create(), SyntaxTreeGroupingFactory.CreateFromText(program, new Mock<IFileResolver>().Object), new Mock<IFileResolver>().Object);
